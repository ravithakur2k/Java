...
public class Main {
    ...
    public static void addItem(){
        ...
        groceryList.groceryListItem(scanner.nextLine());
    }
    ...
    public static void modifyItem(){
        ...
        groceryList.modifyGroceryList(itemNo-1,modifiedItem);
    }

    public static void removeItem(){
        System.out.println("Enter the Item number to be removed : ");
        int removeItemNumber = scanner.nextInt();
        groceryList.removeGroceryItem(removeItemNumber-1);
    }

    public static void searchForItem(){
        System.out.println("Please Enter the Item name ");
        String itemName = scanner.nextLine();
        String searchedItem = groceryList.searchItem(itemName);
